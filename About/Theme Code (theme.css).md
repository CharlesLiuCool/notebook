...
color: #00eeff/*var(--text-title-h2)*/;
...
color: #0073ff/*var(--text-title-h3);*/
...
color: #e88bff/*var(--text-title-h4)*/;
...
/*background-image: linear-gradient(62deg, #87c2fd 0%, #699bff 100%) !important;*/
